/**
 * Created by lWX351071 on 2016/9/7.
 */
var heapsort = {
    ...
    'mgechev': function(a) {
        ...
        var ret = heapSort(a, compare), n= a.length;
...
var test = function () {
    ...
    var sort_obj = heapsort;

    function sort(b) {
        for (var v in sort_obj) {
            var a = b.concat();
            //console.log(filter.indexOf(v), v, a);
            if (filter.indexOf(v) >= 0) {
                console.log(v, sort_obj[v](a, function (x, y) {
                    return x - y
                }));
            }
        }
